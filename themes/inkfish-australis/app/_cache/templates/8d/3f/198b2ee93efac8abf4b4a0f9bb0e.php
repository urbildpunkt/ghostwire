...
/* partials/index-footer.html */
class __TwigTemplate_8d3f198b2ee93efac8abf4b4a0f9bb0e extends Twig_Template
{
    ...
    <div class=\"container\">
        ...
        if (isset($context["page"])) { $_page_ = $context["page"]; } else { $_page_ = null; }
        echo $this->getAttribute($_page_, "root_path");
        echo "/public/docs/js/responsiveslides.min.js\"></script>
        <script>
            \$(function () {
        ...
        // line 72
        if (isset($context["page"])) { $_page_ = $context["page"]; } else { $_page_ = null; }
        echo $this->getAttribute($_page_, "random");
        echo ",
                pause: true
              });
...
";
    ...
    {
        return "partials/index-footer.html";
    }
